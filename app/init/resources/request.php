...
return function (Container $context): void {
    ...
    $context->set('queueForMessaging', fn (Publisher $publisher) => new Messaging($publisher), ['publisher']);
    $context->set('queueForMails', fn (Publisher $publisher) => new Mail($publisher), ['publisher']);
